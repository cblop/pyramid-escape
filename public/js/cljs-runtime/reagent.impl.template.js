...
var G__36184 = o;
(G__36184[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__36188 = o;
(G__36188[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__36235__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
...
while (G__36236__i < G__36236__a.length) {G__36236__a[G__36236__i] = arguments[G__36236__i + 0]; ++G__36236__i;}
  args = new cljs.core.IndexedSeq(G__36236__a,0,null);
} 
return G__36235__delegate.call(this,args);};
G__36235.cljs$lang$maxFixedArity = 0;
G__36235.cljs$lang$applyTo = (function (arglist__36239){
var args = cljs.core.seq(arglist__36239);
return G__36235__delegate(args);
});
...
var G__36191 = props;
var G__36191__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36191,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__36191);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__36191__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__36192){
var map__36193 = p__36192;
var map__36193__$1 = cljs.core.__destructure_map(map__36193);
var props = map__36193__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36193__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__36194){
var map__36195 = p__36194;
var map__36195__$1 = cljs.core.__destructure_map(map__36195);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36195__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__36197 = jsprops;
(G__36197["defaultValue"] = value);

(G__36197["onChange"] = (function (p1__36196_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__36196_SHARP_);
}));
...
var vec__36199 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36199,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36199,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36199,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___36260 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___36260 == null)){
} else {
var key_36262 = temp__5739__auto___36260;
(jsprops["key"] = key_36262);
}
...
var temp__5739__auto___36277 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___36277 == null)){
} else {
var key_36283 = temp__5739__auto___36277;
...
var G__36203 = reagent.impl.template.__GT_NativeWrapper();
(G__36203["name"] = c);
...
var G__36204 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__36204) : reagent.impl.template.as_element.call(null,G__36204));
} else {
...
var len__4771__auto___36292 = arguments.length;
var i__4772__auto___36293 = (0);
while(true){
if((i__4772__auto___36293 < len__4771__auto___36292)){
args__4777__auto__.push((arguments[i__4772__auto___36293]));

var G__36294 = (i__4772__auto___36293 + (1));
i__4772__auto___36293 = G__36294;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq36207){
var G__36208 = cljs.core.first(seq36207);
var seq36207__$1 = cljs.core.next(seq36207);
var self__4758__auto__ = this;
return self__4758__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36208,seq36207__$1);
}));
...
break;
default:
var G__36301 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__36301;
continue;
...
var n__4648__auto___36308 = a.length;
var i_36309 = (0);
while(true){
if((i_36309 < n__4648__auto___36308)){
(a[i_36309] = reagent.impl.template.as_element((a[i_36309])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4648__auto___36311 = a.length;
var i_36312 = (0);
while(true){
if((i_36312 < n__4648__auto___36311)){
var val_36313 = (a[i_36312]);
if(((cljs.core.vector_QMARK_(val_36313)) && ((reagent.impl.template.key_from_vec(val_36313) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_36312] = reagent.impl.template.as_element(val_36313));

var G__36314 = (i_36312 + (1));
i_36312 = G__36314;
continue;
} else {
}
...
var ctx = ({});
var vec__36211 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36211,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36211,(1),null);
...
var G__36220 = (cljs.core.count(argv) - first_child);
switch (G__36220) {
case (0):
