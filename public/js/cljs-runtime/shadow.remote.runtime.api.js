...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30632 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_30632(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_30639 = (function (runtime,key,spec){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_30639(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_30640 = (function (runtime,key){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_30640(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_30641 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_30641(thing,opts);
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30648 = (function (runtime,input,callback){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_30648(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30650 = (function (runtime,code){
var x__4463__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_30650(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__30626,callback){
var map__30627 = p__30626;
var map__30627__$1 = cljs.core.__destructure_map(map__30627);
var input = map__30627__$1;
