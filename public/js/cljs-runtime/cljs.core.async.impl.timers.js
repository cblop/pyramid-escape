...
var i_28703 = (self__.level + (1));
while(true){
if((i_28703 <= (new_level + (1)))){
(update[i_28703] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_28705 = (update[i]).forward;
(x__$2.forward[i] = (links_28705[i]));
...
var links_28713 = (update[i_28710]).forward;
if((x__$1 === (((i_28710 < links_28713.length))?(links_28713[i_28710]):null))){
(links_28713[i_28710] = (x__$1.forward[i_28710]));

var G__28714 = (i_28710 + (1));
i_28710 = G__28714;
continue;
} else {
var G__28715 = (i_28710 + (1));
i_28710 = G__28715;
continue;
}
} else {
